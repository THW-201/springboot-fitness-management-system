...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI问答历史表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `audit_logs`  (
  ...
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '审计日志表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '签到表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `coach_profiles` VALUES (1, 2, '力量训练', '国家一级健身教练', 5, '专注于力量训练和体能提升，帮助学生科学健身', '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL, NULL);
INSERT INTO `coach_profiles` VALUES (2, 3, '瑜伽与柔韧性训练', '国际瑜伽认证教练', 3, '擅长瑜伽和柔韧性训练，注重身心平衡', '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL, NULL);
INSERT INTO `coach_profiles` VALUES (3, 12, '减脂塑形', '国际瑜伽认证教练', 5, '123456', '2026-03-05 11:18:28', '2026-03-11 13:48:53', '123', '123');
INSERT INTO `coach_profiles` VALUES (4, 14, '力量训练', '国家一级健身教练', 5, NULL, '2026-03-05 15:55:56', '2026-03-05 15:55:56', NULL, NULL);
...
-- Records of courses
-- ----------------------------
INSERT INTO `courses` VALUES (1, '力量训练基础课', '适合初学者的力量训练课程，学习基本动作和训练方法', 12, '力量训练', 20, 3, '2026-03-11 05:48:16', '2028-01-06 02:30:00', '健身房A区', 'AVAILABLE', 2, '2026-03-02 23:18:39', '2026-03-02 23:18:39', 'files/course/85a57703-a7a4-4ab9-9fe0-c0caf0689c5e.jpg');
INSERT INTO `courses` VALUES (2, '瑜伽入门课', '瑜伽基础动作教学，提升身体柔韧性和平衡能力', 3, '瑜伽', 15, 0, '2026-03-11 06:06:26', '2026-05-07 07:30:00', '瑜伽室', 'AVAILABLE', 3, '2026-03-02 23:18:39', '2026-03-02 23:18:39', 'files/course/5d6ace7e-8a6a-472b-805e-907f6cb64390.png');
INSERT INTO `courses` VALUES (3, 'HIIT高强度间歇训练', '高强度间歇训练，快速燃脂塑形', 12, 'HIIT', 25, 1, '2024-01-16 10:00:00', '2024-01-16 11:00:00', '健身房B区', 'AVAILABLE', 2, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `courses` VALUES (4, '🏊‍♀️健身', '瘦身塑形', 12, '游泳', 10, 1, '2026-03-05 16:00:00', '2026-03-24 16:00:00', '一楼泳池', 'AVAILABLE', 1, '2026-03-05 15:34:44', '2026-03-05 15:34:44', NULL);
INSERT INTO `courses` VALUES (9, '测试课程', '测试描述', 12, '测试类型', 10, 0, '2026-03-11 08:00:00', '2026-03-13 08:00:00', '一楼大厅', 'AVAILABLE', 1, '2026-03-07 22:28:45', '2026-03-07 22:28:45', NULL);
INSERT INTO `courses` VALUES (10, '瑜伽基础课', '适合初学者的瑜伽课程，帮助学员掌握基本体式和呼吸技巧', 2, '瑜伽', 30, 0, '2026-03-15 10:00:00', '2026-03-18 11:30:00', '健身房A区', 'AVAILABLE', 1, '2026-03-07 23:12:24', '2026-03-07 23:12:24', NULL);
INSERT INTO `courses` VALUES (11, '瑜伽基础课', '适合初学者的瑜伽课程，帮助学员掌握基本体式和呼吸技巧', 2, '瑜伽', 30, 0, '2026-03-15 10:00:00', '2026-03-19 11:30:00', '健身房A区', 'AVAILABLE', 1, '2026-03-07 23:12:45', '2026-03-07 23:12:45', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '器材表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of equipment
-- ----------------------------
INSERT INTO `equipment` VALUES (1, '跑步机-01', '有氧器械', 'ProForm跑步机，支持多种训练模式', '有氧区A-01', 'AVAILABLE', '2023-01-01', NULL, NULL, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `equipment` VALUES (2, '跑步机-02', '有氧器械', 'ProForm跑步机，支持多种训练模式', '有氧区A-02', 'IN_USE', '2023-01-01', NULL, NULL, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `equipment` VALUES (3, '哑铃组-10kg', '力量器械', '10kg哑铃一对', '力量区B-01', 'AVAILABLE', '2023-02-01', NULL, NULL, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `equipment` VALUES (4, '哑铃组-20kg', '力量器械', '20kg哑铃一对', '力量区B-02', 'AVAILABLE', '2023-02-01', NULL, NULL, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `equipment` VALUES (5, '瑜伽垫-01', '辅助器材', '专业瑜伽垫，防滑耐用', '瑜伽室C-01', 'AVAILABLE', '2023-03-01', NULL, NULL, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `equipment` VALUES (6, '动感单车-01', '有氧器械', '专业动感单车，可调节阻力', '有氧区A-03', 'AVAILABLE', '2023-04-01', NULL, NULL, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `equipment` VALUES (9, '测试器材', '有氧器材', '测试测试测试测试测试测试', '二楼B区05号', 'AVAILABLE', '2026-03-04', NULL, '', '2026-03-07 19:50:05', '2026-03-07 19:50:05', NULL);
INSERT INTO `equipment` VALUES (10, '测器材-2', '自由重量', '测试测试测试测试测试测试测试测试测试测试', '大门左侧', 'IN_USE', '2026-03-03', NULL, 'files/equipment/587c8a5f-ea9f-4de0-9a7d-5d4618d30279.jpg', '2026-03-07 22:29:09', '2026-03-07 22:29:09', NULL);
...
CREATE TABLE `exercise_records`  (
  ...
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `exercise_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '运动类型',
  `duration_minutes` int NOT NULL COMMENT '运动时长（分钟）',
  `calories_burned` int NOT NULL COMMENT '消耗卡路里',
  `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '运动地点',
  ...
  CONSTRAINT `fk_exercise_student` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '运动打卡记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exercise_records
-- ----------------------------
INSERT INTO `exercise_records` VALUES (1, 15, 'RUNNING', 30, 300, '操场', '', '2026-03-16', '2026-03-16 02:21:01', '2026-03-16 02:21:01');
INSERT INTO `exercise_records` VALUES (2, 15, 'OTHER', 15, 150, '宿舍', '', '2026-03-17', '2026-03-17 00:46:11', '2026-03-17 00:46:11');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '健康建议表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '健康计划表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '预约表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `social_comment`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社交评论表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社交关注表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `social_like`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社交点赞表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `social_post`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社交帖子表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社交话题表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社交举报表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `student_profiles` VALUES (2, 5, '2021002', 2, 'FEMALE', 19, 165.00, 55.00, 0, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `student_profiles` VALUES (3, 6, '2021003', 3, 'MALE', 21, 180.00, 75.00, 0, '2026-03-02 23:18:39', '2026-03-02 23:18:39', NULL);
INSERT INTO `student_profiles` VALUES (8, 11, '9981982', 12, NULL, NULL, NULL, NULL, 0, '2026-03-05 11:04:35', '2026-03-05 11:04:35', NULL);
INSERT INTO `student_profiles` VALUES (9, 13, '20210101', 1, NULL, NULL, NULL, NULL, 0, '2026-03-05 15:55:30', '2026-03-05 15:55:30', NULL);
INSERT INTO `student_profiles` VALUES (10, 15, '2224120305', NULL, NULL, NULL, NULL, NULL, 0, '2026-03-14 21:32:49', '2026-03-14 21:32:49', NULL);
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', '$2a$10$/lhPiCU5vB85Q0xzwpLaC.IrjsgrjtqFPMR2PvFrV3J9lyC2W786u', 'admin@fitness.edu.cn', '13800138009', '管理员', 'ADMIN', 'files/avatar/12b8785c-765a-45b6-9655-b1313ce10dce.jpg', 1, '2026-03-02 23:18:39', '2026-03-03 10:25:15');
...
INSERT INTO `users` VALUES (3, 'coach2', '$2a$10$/lhPiCU5vB85Q0xzwpLaC.IrjsgrjtqFPMR2PvFrV3J9lyC2W786u', 'coach2@fitness.edu.cn', '13800138002', '李教练', 'COACH', NULL, 1, '2026-03-02 23:18:39', '2026-03-03 10:25:15');
INSERT INTO `users` VALUES (5, 'student2', '$2a$10$/lhPiCU5vB85Q0xzwpLaC.IrjsgrjtqFPMR2PvFrV3J9lyC2W786u', 'student2@fitness.edu.cn', '13800138004', '李小红', 'STUDENT', NULL, 1, '2026-03-02 23:18:39', '2026-03-03 10:25:15');
INSERT INTO `users` VALUES (6, 'student3', '$2a$10$/lhPiCU5vB85Q0xzwpLaC.IrjsgrjtqFPMR2PvFrV3J9lyC2W786u', 'student3@fitness.edu.cn', '13800138005', '张小华', 'STUDENT', NULL, 1, '2026-03-02 23:18:39', '2026-03-03 10:25:15');
...
INSERT INTO `users` VALUES (15, 'student', '$2a$10$FMh6uw/pO0cZpsaUCtSlSuLqq.hJECDLhubdYDgQLoLA0scknjWRi', '3365286127@qq.com', NULL, NULL, 'STUDENT', NULL, 1, '2026-03-14 21:32:49', '2026-03-14 21:32:49');
